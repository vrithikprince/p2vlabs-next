 ...
 * Third tier is filled with the accent (the focal anchor; corresponds to
 * the "you choose here" buyer moment). Hairline weight (1.2px) and a
 * single accent match the illustration language used across the site.
 *
...
export default function PricingIllustration() {
  const stroke = 'rgba(26,31,35,0.38)'
  const baseline = 'rgba(26,31,35,0.22)'
  /* violet, matching the eyebrow dot PageHeader renders directly above this
     illustration - the two read as one unit, so they share one accent */
  const accent = '#a273ff'
  ...
  return (
    ...
    >
      ...
      {/* Tier 3 - focal, accent */}
      <rect x="106" y="42"  width="32" height="96"  fill={accent} />
      ...
      <circle cx="122" cy="42"  r="2"   fill={accent} />
