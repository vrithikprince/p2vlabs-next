...
export function organizationJsonLd() {
  return {
    ...
    name:         SITE_NAME,
    /* alternateName tells Google "P2V Labs" and "Pixels to Visuals"
       point at the same entity. Bridges the brand schema to the GBP
       (originally registered with the longer name) and to AI Overviews
       that already use "stylized as p2v_labs" — so the knowledge graph
       sees one business, not three. */
